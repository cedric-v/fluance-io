  ...
  <div class="section-card p-8 bg-white space-y-6">
    ...
    <div class="grid md:grid-cols-2 gap-6">
      <div class="quote-card">
        ...
        <p class="text-sm text-[#0f172a]/60 mt-2">— France</p>
      </div>
      <div class="quote-card">
        <p class="italic text-[#0f172a]/80">"Ca m'<strong>a fait du bien</strong>. Merci bcp 🙏"</p>
        <p class="text-sm text-[#0f172a]/60 mt-2">— Peggy</p>
      </div>
      <div class="quote-card">
        <p class="italic text-[#0f172a]/80">"J'ai trouvé cette pratique <strong>agréable</strong>, <strong>facile</strong>, réalisable par le plus grand nombre."</p>
        <p class="text-sm text-[#0f172a]/60 mt-2">— Brigitte</p>
      </div>
      <div class="quote-card">
        <p class="italic text-[#0f172a]/80">"Cet exercice m'aide à <strong>plus de souplesse</strong>."</p>
        <p class="text-sm text-[#0f172a]/60 mt-2">— Patricia</p>
      </div>
      <div class="quote-card">
        <p class="italic text-[#0f172a]/80">"Toujours <strong>génial</strong> de prendre 10 mn pour soi. J'ai <strong>hâte</strong>, à demain. Merci, gratitudes."</p>
        <p class="text-sm text-[#0f172a]/60 mt-2">— Cathy</p>
      </div>
      <div class="quote-card">
        <p class="italic text-[#0f172a]/80">"Merci ! <strong>Court et efficace</strong> !"</p>
        <p class="text-sm text-[#0f172a]/60 mt-2">— Hélène</p>
      </div>
    </div>
  </div>
