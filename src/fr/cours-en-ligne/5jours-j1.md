...
<section class="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-8">
  <header class="text-center space-y-6">
    ...
    <div class="flex flex-wrap justify-center gap-4 text-lg font-semibold text-fluance">
      <span class="px-4 py-2 bg-fluance/10 rounded-full">Jour 1<br><span class="text-base font-normal">S'ancrer et détendre</span></span>
  ...
  <div class="section-card p-8 bg-white space-y-6">
    <h2 class="text-2xl font-semibold text-fluance text-center">Ancrage et détente :</h2>
    ...
    <div class="max-w-md mx-auto space-y-4">
      ...
      function buildCommentPageIds(pathname) {
        ...
        var urls = [
          ...
          'https://fluance.io/par/5j-bienvenue'
        ];
        var pageIdsByUrl = {};
