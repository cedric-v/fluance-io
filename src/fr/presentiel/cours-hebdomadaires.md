...
<section class="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-8">
  ...
  <article class="prose prose-lg max-w-none space-y-6 text-[#1f1f1f]">
    <p class="text-lg text-[#0f172a]/75">
      Rejoignez nos cours hebdomadaires en présentiel pour pratiquer le mouvement, la respiration et la méditation dans un cadre bienveillant et accompagné.
    </p>
    ...
    <div class="section-card p-8 bg-white">
      ...
      <ul class="space-y-3 text-[#0f172a]/80">
        ...
        <li>• Groupe limité pour un accompagnement personnalisé</li>
    ...
    <div class="text-center pt-6">
      <a href="{{ '/#contact' | url }}" class="btn-primary inline-flex">S'inscrire aux cours</a>
    </div>
  </article>
</section>
