...
<section class="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-8">
  <header class="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] -mt-28 mb-8 overflow-hidden" style="height: 300px;">
    ...
    <div class="relative z-10 h-full flex flex-col items-center justify-center px-6 md:px-12 text-center">
      <h1 class="text-4xl font-semibold text-white drop-shadow-lg">L'approche Fluance</h1>
    </div>
  </header>

  <article class="prose prose-lg max-w-none space-y-8 text-[#1f1f1f]">
    <div class="space-y-6">
      <h2 class="text-2xl font-semibold text-[#82153e] text-center">Le trépied de la vitalité :</h2>
    ...
    <div class="space-y-6 pt-6 border-t border-[#82153e]/10">
      <div class="space-y-3">
        <h3 class="text-xl font-semibold text-[#82153e]">Mouvement :</h3>
        <p class="text-lg text-[#0f172a]/75 leading-relaxed">
      ...
      <div class="space-y-3">
        <h3 class="text-xl font-semibold text-[#82153e]">Souffle :</h3>
        <p class="text-lg text-[#0f172a]/75 leading-relaxed">
      ...
      <div class="space-y-3">
        <h3 class="text-xl font-semibold text-[#82153e]">Jeu :</h3>
        <p class="text-lg text-[#0f172a]/75 leading-relaxed">
    ...
    <div class="space-y-4 pt-6 border-t border-[#82153e]/10">
      <h2 class="text-2xl font-semibold text-[#82153e]">Des pratiques simples, puissantes et libératrices</h2>
      <p class="text-lg text-[#0f172a]/75 leading-relaxed">
    ...
    <div class="space-y-4 pt-6 border-t border-[#82153e]/10">
      <h2 class="text-2xl font-semibold text-[#82153e]">La magie de la régularité</h2>
      <p class="text-lg text-[#0f172a]/75 leading-relaxed">
        Comme une goutte d'eau qui finit par sculpter la pierre, c'est la répétition qui crée la transformation profonde.
      </p>
      
      <div class="bg-[#82153e]/5 border-l-4 border-[#82153e] p-6 rounded-r-lg mt-6">
