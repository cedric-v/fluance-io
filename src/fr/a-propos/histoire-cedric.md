...
<section class="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-8">
  ...
  <article class="max-w-none space-y-12 text-[#1f1f1f]">
    ...
    <div class="flex flex-col md:flex-row gap-8 items-start">
      <div class="w-full md:w-1/2 md:order-1">
        <div class="aspect-4/3 rounded-lg overflow-hidden">
          {% responsiveImage "/assets/img/cedric-enfant-2012.jpg", "Cédric avec ses enfants", "100vw", "w-full h-full object-cover", "lazy" %}
        </div>
      </div>
      <div class="w-full md:w-1/2 md:order-2 space-y-4">
    ...
    <div class="flex flex-col md:flex-row gap-8 items-start">
      <div class="w-full md:w-1/2 md:order-1">
        <div class="aspect-3/4 rounded-lg overflow-hidden">
          {% responsiveImage "/assets/img/cedric-fluance-particuliers.jpg", "Cédric - Le retour à la simplicité", "100vw", "w-full h-full object-cover object-center", "lazy" %}
        </div>
      </div>
      <div class="w-full md:w-1/2 md:order-2 space-y-4">
  ...
  <div class="pt-8 mt-8 border-t border-fluance/20">
    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
      <a href="{{ '/a-propos/philosophie/' | relativeUrl }}" class="btn-primary !text-[#7A1F3D] bg-[#E6B84A] hover:bg-[#E8C15A] text-center flex items-center justify-center min-h-[3.5rem]">
        Philosophie
      </a>
