...
<section class="max-w-4xl mx-auto px-6 md:px-12 py-12 space-y-8">
  <header class="space-y-2 text-center">
    ...
    <p class="text-[#0f172a]/70">Contenu reproduit depuis <a class="underline" href="https://fluance.io/mentions-legales" target="_blank" rel="noopener">fluance.io</a>.</p>
  </header>
...
Par la présente, nous nous efforcerons de répondre aux questions suivantes : Quelles données personnelles traitons-nous ? Dans quels buts ? Sur quelles bases légales ? Quels sont vos droits ? Comment les exercer ? Pendant combien de temps les données sont-elles conservées ?

Vous trouverez également nos engagements en matière de sous-traitance, de transferts, de communication à des tiers et en cas de faille de sécurité. Pour toute précision ou réclamation, n’hésitez pas à nous contacter.

## Quelles sont les catégories de données personnelles collectées et traitées ?

Dans le cadre de notre activité, sur fluance.io, www.techniquesdemeditation.com, www.vie-explosive.com, www.developpementpersonnel.org, www.instant-academie.com, instant-academie.net et cedricv.com (ci-après le « Site »), vous nous transmettez les informations suivantes en remplissant le(s) formulaire(s) de renseignement et en communiquant avec nous :
...
1. L’exécution de la relation contractuelle (les données sont nécessaires pour réaliser les prestations sollicitées au titre des CGV).
2. La protection de nos intérêts légitimes (prospection commerciale, preuve des transactions, recouvrement).
3. Lorsque la loi l’exige ou en l’absence des cas précédents, votre consentement exprès.
...
En vous inscrivant, vous consentez à ce que vos commentaires et/ou votre image soient réutilisés dans la rediffusion ou les communications liées à l’événement. En acceptant d’interagir visuellement, vous acceptez implicitement que votre image et votre voix apparaissent dans la rediffusion.
...
Les demandes sont à adresser à : support@instant-academie.com, avec justification d’identité et, le cas échéant, de vos motifs. L’exercice de certains droits peut perturber voire interrompre la fourniture de services (ex : commande en cours).

Plus d’informations : https://www.cnil.fr/fr/les-droits-pour-maitriser-vos-donnees-personnelles

## Sous-traitance

Nous pouvons faire appel à un ou plusieurs sous-traitants pour des activités de traitement spécifiques. Nous nous engageons à ce que tout sous-traitant présente des garanties suffisantes quant à la mise en œuvre des mesures techniques et organisationnelles appropriées pour répondre aux exigences du RGPD.

## Communication des données personnelles à des tiers

Nous ne partageons aucune donnée personnelle à des fins commerciales sans votre consentement. En cas de communication à un tiers, nous veillons à l’application de conditions de confidentialité identiques aux nôtres. Sur obligation légale, les données peuvent être divulguées aux autorités publiques. Dans le cadre des commandes, les données sont transmises à nos fournisseurs, sous-traitants et filiales strictement nécessaires à l’exécution du contrat. En cas d’opération de fusion/acquisition, nous garantissons la confidentialité et informerons avant tout transfert.

### Communication à des tiers partenaires

Certaines données peuvent être mises à disposition de partenaires stratégiques pour fournir ou promouvoir nos produits et services.

### Communication à des tiers pour marketing direct

Sous réserve de votre accord (et à moins d’opposition), nous pouvons partager des informations avec des partenaires publicitaires pour des communications promotionnelles ciblées.

## Réseaux sociaux et sites tiers

La connexion à un service tiers (réseau social, etc.) peut entraîner la communication de vos informations de profil. Le Site contient des liens vers d’autres sites ; nous ne sommes pas responsables de leur traitement des données.

## Indications en cas de faille de sécurité

Nous mettons en œuvre les mesures nécessaires pour garantir un niveau de sécurité adapté. En cas d’accès illégal ou non autorisé, nous nous engageons à notifier l’incident si nécessaire, à en examiner les causes et à prendre les mesures raisonnables pour en amoindrir les effets.
...
La présente Politique est régie par le droit suisse. Elle est rédigée en français. En cas de traduction, seul le texte français fait foi.

## Mentions légales

1/ **Editeur des sites** www.techniquesdemeditation.com, www.vie-explosive.com, www.developpementpersonnel.org, www.instant-academie.com, instant-academie.net, cedricv.com, fluance.io.

Instants Zen, société à responsabilité limitée (Sàrl) enregistrée en Suisse, capital 20 000 CHF.

**Numéro du registre de commerce :** CH-217.3.558.474-0

**Siège social :** Case postale, 1782 Belfaux, Suisse

**Tél. :** +33 (0)9 72 13 33 88

**Email :** support@instant-academie.com
...
5/ **Liens hypertextes :** Le site peut diriger vers d’autres sites de l’Editeur ou de tiers. L’Editeur ne saurait être tenu responsable des informations diffusées sur ces sites. L’Editeur se réserve la possibilité de demander la suppression d’un lien hypertexte pointant vers son site s’il estime que ce lien n’est pas conforme à ses droits et intérêts légitimes.
  </article>
</section>
