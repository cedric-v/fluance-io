...
<section class="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-8">
  ...
  <article class="prose prose-lg max-w-none space-y-8 text-[#1f1f1f]">
    <div class="space-y-6">
      <h2 class="text-2xl font-semibold text-[#82153e] text-center">The tripod of vitality:</h2>
    ...
    <div class="space-y-6 pt-6 border-t border-[#82153e]/10">
      <div class="space-y-3">
        <h3 class="text-xl font-semibold text-[#82153e]">Movement:</h3>
        <p class="text-lg text-[#0f172a]/75 leading-relaxed">
      ...
      <div class="space-y-3">
        <h3 class="text-xl font-semibold text-[#82153e]">Breath:</h3>
        <p class="text-lg text-[#0f172a]/75 leading-relaxed">
      ...
      <div class="space-y-3">
        <h3 class="text-xl font-semibold text-[#82153e]">Play:</h3>
        <p class="text-lg text-[#0f172a]/75 leading-relaxed">
    ...
    <div class="space-y-4 pt-6 border-t border-[#82153e]/10">
      <h2 class="text-2xl font-semibold text-[#82153e]">Simple, powerful and liberating practices</h2>
      <p class="text-lg text-[#0f172a]/75 leading-relaxed">
    ...
    <div class="space-y-4 pt-6 border-t border-[#82153e]/10">
      <h2 class="text-2xl font-semibold text-[#82153e]">The magic of regularity</h2>
      <p class="text-lg text-[#0f172a]/75 leading-relaxed">
  ...
  <div class="pt-8 mt-8 border-t border-[#82153e]/20">
    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
      ...
      <a href="{{ '/en/a-propos/histoire-cedric/' | url }}" class="btn-primary text-[#0f172a] bg-[#ffce2d] hover:bg-[#ffd84d] text-center">
        Cédric's story
      </a>
