...
<section class="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-8">
  ...
  <article class="prose prose-lg max-w-none space-y-8 text-[#1f1f1f]">
      <div class="space-y-4">
      <h2 class="text-2xl font-semibold text-[#82153e]">Awakening doesn't require leaving the world, but fully inhabiting it.
      </h2>
    ...
    <div class="space-y-4 pt-6 border-t border-[#82153e]/10">
      <h2 class="text-2xl font-semibold text-[#82153e]">Your tensions are levers</h2>
      <p class="text-lg text-[#0f172a]/75 leading-relaxed">
    ...
    <div class="space-y-4 pt-6 border-t border-[#82153e]/10">
      <h2 class="text-2xl font-semibold text-[#82153e]">Everything is already within you</h2>
      <p class="text-lg text-[#0f172a]/75 leading-relaxed">
    ...
    <div class="space-y-4 pt-6 border-t border-[#82153e]/10">
      <h2 class="text-2xl font-semibold text-[#82153e]">A joyful gateway</h2>
      <p class="text-lg text-[#0f172a]/75 leading-relaxed">
