...
<script>
  ...
  // Protection anti-scraping : construction dynamique du numéro WhatsApp
  (function() {
    function initMessaging() {
      const countryCode = '41';
      const phoneParts = ['76', '673', '8311'];
