...
<section class="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-8">
  <header class="space-y-4 text-center">
    <p class="cta-pill bg-[#8bc34a]/20 text-[#82153e] inline-flex">Switzerland - Fribourg</p>
    <h1 class="text-4xl font-semibold text-[#0f172a]">Weekly Classes</h1>
  </header>

  <article class="prose prose-lg max-w-none space-y-6 text-[#1f1f1f]">
    <div class="section-card p-8 bg-white space-y-6">
      <h2 class="text-2xl font-semibold text-[#82153e] mb-4">Join the movement</h2>
    ...
    <div class="section-card p-8 bg-white">
      ...
      <ul class="space-y-3 text-[#0f172a]/80 mb-6">
        <li>• Regular classes every week</li>
        <li>• Small groups for quality support</li>
        <li>• Practices adapted to all levels</li>
      ...
      <div class="mt-6 pt-6 border-t border-[#82153e]/20">
        ...
        <p class="text-[#0f172a]/80">Would you like a different time? <a href="{{ '/en/contact/' | relativeUrl }}" class="text-[#82153e] hover:underline">Make a request</a>. If there are enough requests, a new time slot will be opened.</p>
      </div>
      <div class="mt-6 pt-6 border-t border-[#82153e]/20">
        <h3 class="text-xl font-semibold text-[#82153e] mb-3">Join our WhatsApp group</h3>
        <p class="text-[#0f172a]/80 mb-3">Stay connected with the community and receive the latest information about classes.</p>
      ...
      <div class="mt-6 pt-6 border-t border-[#82153e]/20">
        <h3 class="text-xl font-semibold text-[#82153e] mb-3">Pricing</h3>
        ...
        <div class="space-y-4">
          <div class="border-l-4 border-[#82153e] pl-4">
            <h4 class="text-lg font-semibold text-[#82153e] mb-2">À la carte: 25 CHF per session</h4>
          ...
          <div class="border-l-4 border-[#82153e] pl-4">
            ...
            <p class="text-[#0f172a]/80 mt-2">
              Your card is valid for 16 weeks (4 months) to give you time to practice at your own pace.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="section-card p-8 bg-white">
      <h2 class="text-2xl font-semibold text-[#82153e] mb-4">Frequently Asked Questions</h2>
      <div class="space-y-6">
        <div>
          <h3 class="text-xl font-semibold text-[#82153e] mb-2">What should I bring to a class?</h3>
          <p class="text-[#0f172a]/80">Comfortable clothing and something to hydrate with.</p>
        </div>
        <div>
    ...
    <div class="text-center pt-6">
      <a href="https://chat.whatsapp.com/DUDkFnpLdw0DyhSdhH1zDN" target="_blank" rel="noopener noreferrer" class="btn-primary inline-flex">Join the WhatsApp group</a>
    </div>
  </article>
</section>
