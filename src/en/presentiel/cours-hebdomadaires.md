  ...
  <article class="prose prose-lg max-w-none space-y-6 text-[#1f1f1f]">
    ...
    <div class="section-card p-8 bg-white">
      ...
      <div class="mt-6 pt-6 border-t border-[#82153e]/20">
        <h3 class="text-xl font-semibold text-[#82153e] mb-3">Location: Fribourg (Switzerland)</h3>
      ...
      <div class="mt-6 pt-6 border-t border-[#82153e]/20">
        <h3 class="text-xl font-semibold text-[#82153e] mb-3">Mandatory registration</h3>
