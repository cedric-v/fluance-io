...
<section class="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-8">
  <header class="space-y-4 text-center">
    <p class="cta-pill bg-[#8bc34a]/20 text-fluance inline-flex">Switzerland - Fribourg</p>
  ...
  <article class="prose prose-lg max-w-none space-y-6 text-[#1f1f1f]">
    ...
    <div class="section-card p-8 bg-white">
      ...
      <div class="mt-6 pt-6 border-t border-fluance/20">
        <h3 class="text-xl font-semibold text-fluance mb-3">Location: Fribourg (Switzerland)</h3>
      ...
      <div class="mt-6 pt-6 border-t border-fluance/20">
        ...
        <p class="text-[#0f172a]/80 mb-2"><strong>Classes will begin in January 2026.</strong></p>
        ...
        <p class="text-[#0f172a]/80">Would you like a different time? <a href="{{ '/en/contact/' | relativeUrl }}" class="text-fluance hover:underline">Make a request</a>. If there are enough requests, a new time slot will be opened.</p>
      </div>
      <div class="mt-6 pt-6 border-t border-fluance/20">
    ...
    <div class="section-card p-8 bg-white">
      ...
      <div class="space-y-6">
        ...
        <div>
          ...
          <p class="text-[#0f172a]/80 mb-4">By bank card or TWINT when booking online, or cash on site before the start of the class.</p>
