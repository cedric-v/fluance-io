...
<section class="max-w-4xl mx-auto px-6 md:px-12 py-16 space-y-12">
  <header class="text-center space-y-4">
    <h1 class="text-4xl font-semibold text-[#3E3A35]">Inspired by Nature</h1>
    <p class="text-xl text-[#3E3A35] font-medium">
      I'm taking you on a walk with me, sharing some refreshing moments in nature
    </p>
  </header>
  ...
  <article class="prose prose-lg max-w-none space-y-12 text-[#1f1f1f]">
    <div class="section-card p-8 bg-white space-y-6">
      ...
      <p class="text-lg text-[#3E3A35] text-center">
        These videos are moments of resourcing in nature that I share with you. 
        You can watch them whenever you feel the need, to recharge, take a step back, or ground yourself.
      </p>
      <p class="text-sm text-[#3E3A35]/60 italic text-center">
        (Sorry for the poor quality of sound and image. I will try to do better with the next ones.)
      </p>
    </div>
    ...
    <div class="space-y-12">
      ...
      <div class="section-card p-8 bg-white space-y-6">
        ...
        <h4 class="text-xl font-medium text-[#3E3A35] text-center">Walk by the water</h4>
      ...
      <div class="section-card p-8 bg-white space-y-6">
        ...
        <h4 class="text-xl font-medium text-[#3E3A35] text-center">At the summit</h4>
        <div class="relative w-full" style="padding-bottom: 56.25%;">
          <iframe 
      ...
      <div class="section-card p-8 bg-white space-y-6">
        ...
        <h4 class="text-xl font-medium text-[#3E3A35] text-center">Walk in the snow</h4>
        <div class="relative w-full" style="padding-bottom: 56.25%;">
          <iframe 
